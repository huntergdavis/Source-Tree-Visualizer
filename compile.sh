...
g++ -g -Wall -W -pthread -std=c++0x -o bin/simple_tree src/dis/stv/main/simple_tree.cpp src/dis/stv/io/git_repository_access.cpp src/dis/stv/gen/space_colonizer.cpp src/dis/stv/draw/scanline_artist.cpp src/dis/stv/dec/spatial_displacement.cpp -Isrc/dis/stv/dec -Isrc/dis/stv/draw -Isrc/dis/stv/gen -Isrc/dis/stv/io -Isrc/dis/stv/main -I/usr/local/boost -I/usr/include/ImageMagick -L/usr/lib -Wl,-Bsymbolic-functions -L/usr/lib/X11 -L/usr/lib -lMagick++ -lMagickWand -lMagickCore -llcms -ltiff -lfreetype -ljpeg -lXext -lSM -lICE -lX11 -lXt -lbz2 -lz -lm -lgomp -lpthread -lltdl > ./compile_results.txt
